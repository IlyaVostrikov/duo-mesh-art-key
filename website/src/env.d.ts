...
interface ArtKeyVerification { artKey: { keyCode: string; ownerKey: string; integrityHash: string; issuedAt: string }; artwork: { title: string } | null; artist: { displayName: string | null } | null; provenance: { transferType: string; toOwnerName: string | null; createdAt: string }[]; verified: boolean; currentOwner: string | null }
